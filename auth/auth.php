...
if (isset($_POST["submit"])) {
    ...
    if ($count == 1) {
        ...
        $mail->Subject = "Your OTP For AGRIM";
       ...
       <div class="signin-right">
         ...
         <div class="signin-box">
           ...
           <div class="form-group">
              <?php
              if(!empty($Error)): //CHecking if String Error contains value or not.
             ...
             <p class="mg-b-0 text-right">or login via <a href="./authsms.php">Phone Number</a></p>
           </div><!-- form-group -->
           <input type="submit" class="btn btn-primary btn-block btn-signin" name="submit" value="Send OTP">
         </form>
           <p class="mg-b-0">Don't have an account? <a href="./register.php">Register Now</a></p>
         </div>
