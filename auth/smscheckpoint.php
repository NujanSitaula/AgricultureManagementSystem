...
if(isset($_SESSION['EMAIL'])){
 ...
 $phoneError = "<div class='alert alert-success' role='alert'>
   ...
   <strong>Yey!</strong> OTP has been sent to your Phone.
 </div>";
  if(isset($_POST['verify']))
      {
  $otp=$_POST['otp'];
  $phone=$_SESSION['EMAIL'];
  $res=mysqli_query($con,"SELECT * FROM ams_users WHERE Phone='$phone' and OTP='$otp'");
  ...
  if($count>0){
    ...
    $phoneError = "<div class='alert alert-danger' role='alert'>
      ...
      <strong>You Missed It!</strong> Please enter a valid OTP.
    </div>";
  }
  }
  }
			...
			<div class="d-md-flex flex-row-reverse">
				<div class="signin-right">
					...
					<div class="signin-box">
						...
						<form method="post" action="smscheckpoint.php">
