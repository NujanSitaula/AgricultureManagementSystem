  ...
  <body>
    ...
    <div class="signin-wrapper">
      ...
      <div class="signin-box signup">
        ...
        <h3 class="signin-title-primary mb-4 mt-4 text-center">Paymant Successful</h3>
        ...
        <a href="../index.php"><button name="install" class="btn btn-primary btn-block btn-signin">View Inventory</button></a>

        <p class="mg-t-40 mg-b-0">Need Help With Payment? <a href="page-signin.html">Contact Us</a></p>
      </div><!-- signin-box -->
